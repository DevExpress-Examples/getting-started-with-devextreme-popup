<!-- default badges list -->
![](https://img.shields.io/endpoint?url=https://codecentral.devexpress.com/api/v1/VersionRange/355513332/25.2.3%2B)
...
- **Vue**
    ...
    - [PopupContent.vue](Vue/src/components/PopupContent.vue)
